        ...
        <div class="col-lg-8">
            ...
            <form action="/post" method="post">
                ...
                <div class="form-floating mt-2">
                    ...
                    @enderror
                <div class="form-floating mt-2">
                    <input type="text" name="no_kk" class="form-control @error('no_kk') is-invalid @enderror"  id="no_kk" placeholder="name@example.com" required value="{{ old ('no_kk') }}">
                ...
                <div class="form-floating mt-2">
                    <input type="text" name="jenis_kelamin" class="form-control @error('jenis_kelamin') is-invalid @enderror" id="jenis_kelamin" placeholder="jenis_kelamin" required  value="{{ old ('jenis_kelamin') }}">
                    <label for="jenis_kelamin">Jenis Kelamin</label>
                </div>
                
                <div class="form-floating mt-2">
                    <input type="text" name="tempat_lahir" class="form-control @error('tempat_lahir') is-invalid @enderror" id="tempat_lahir" placeholder="tempat_lahir" required  value="{{ old ('tempat_lahir') }}">
                ...
                <div class="form-floating mt-2">
                    <input type="text" name="tahun_masuk" class="form-control @error('tahun_masuk') is-invalid @enderror" id="tahun_masuk" placeholder="tahun_masuk" required  value="{{ old ('tahun_masuk') }}">
                    <label for="tahun_masuk">Tahun Masuk</label>
                </div>

                <button class="w-100 btn btn-lg btn-primary mt-3 mb-10" type="submit">Register</button>
                <br>
                <br>
                <br>
                <br>
